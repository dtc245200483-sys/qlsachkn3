...
## Định dạng log nhận vào
[BACKEND]/[FRONTEND]/[AI_ENGINE] <thời gian> - Thay đổi - Chức năng đề bài
lionn quan - Ảnh hưởng agent khác.
...
## Cập nhật Giai đoạn Kiểm thử & Cải tiến
- **Ngày 2026-08-10 (06:45:01 - 09:20:00)**: Chạy hàng chục vòng lặp kiểm thử (iterations) giữa Frontend và Backend. Bắt và sửa các lỗi lệch pha (như vụ thiếu biến `so_ngay_muon`, sai kiểu dữ liệu phạt điểm).
- **Ngày 2026-08-27 (07:10:00 - 22:20:00)**: Cải tiến UI/UX toàn diện. Hoàn thiện toàn bộ các màn hình Quản lý độc giả, Quản lý sách, Mượn trả và Thống kê. Làm mịn các luồng thao tác và hiển thị cảnh báo lỗi nội tuyến (API error handling). Rà soát phân quyền Admin.

## Cập nhật Giai đoạn Hoàn thiện Tổng duyệt
- **Ngày 2026-08-28 (01:40:00 - 03:00:00)**: Cập nhật Database & Dữ liệu. Xoá 60 sách mẫu rác, cập nhật thành công 64 cuốn sách chuyên ngành từ Fahasa/Tiki thuộc 8 thể loại. Mã sách chuyển sang quy tắc viết tắt + 4 số tăng dần toàn cục (ví dụ BMTM0005) để chống trùng lặp.
- **Ngày 2026-08-29 (13:15:00 - 15:00:00)**: Áp dụng Defensive Programming cho Backend. Đã đóng băng logic và vá các lỗ hổng nghiêm trọng. Ngăn chặn tuyệt đối hành vi xoá độc giả nếu đang mượn sách, nợ phạt hoặc có yêu cầu đặt trước. Rà soát toàn bộ thư mục `docs/minhchung/` và xác nhận khớp 100% với log hệ thống. Mọi file trong `thuky` đã được cập nhật mốc thời gian chính xác từng giờ để sẵn sàng nộp báo cáo.
